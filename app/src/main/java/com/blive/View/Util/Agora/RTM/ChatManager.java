package com.blive.View.Util.Agora.RTM;
...
public class ChatManager {
    ...
    public void doLogin() {
        ...
        mRtmClient.login(null, SessionUser.Companion.getUser().getUsername().trim(), new ResultCallback<Void>() {
            @Override
            public void onSuccess(Void responseInfo) {
                Log.e(TAG, "RTM login success 1");
                SessionUser.Companion.isRtmLoggedIn(true);
            ...
            public void onFailure(ErrorInfo errorInfo) {
                ...
                SessionUser.Companion.isRtmLoggedIn(false);
            }
        });
    }
