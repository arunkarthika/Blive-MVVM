...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.blive.R.layout.activity_main1)

        btnLogin = findViewById(com.blive.R.id.btnLogin) as Button
        btnLogin!!.setOnClickListener(this)
        btnLogin!!.visibility = View.VISIBLE

        btnLogut = findViewById(com.blive.R.id.btnLogut) as Button
        btnLogut!!.setOnClickListener(this)
        btnLogut!!.visibility = View.GONE

        txtViewDetails = findViewById(com.blive.R.id.txtViewDetails) as TextView
